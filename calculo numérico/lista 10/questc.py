...
p4 = np.polymul(p3, T[4,4])
print('-----------------------------------------------')
print('\np3*a4:\n', p4)

p5 = np.polymul(p3, T[5,5])
print('-----------------------------------------------')
print('\np3*a4:\n', p5)
...
# Denominador
d = (x[0] - x[1])*(x[0] - x[2])*(x[0] - x[3])*(x[0] - x[4])*(x[0] - x[5])
...
d = (x[1] - x[0])*(x[1] - x[2])*(x[1] - x[3])*(x[1] - x[4])*(x[0] - x[5])
px1 = np.poly1d([1, -x[0]])
px2 = np.poly1d([1, -x[2]])
px3 = np.poly1d([1, -x[3]])
px4 = np.poly1d([1, -x[4]])
...
d = (x[2] - x[0])*(x[2] - x[1])*(x[2] - x[3])*(x[1] - x[4])*(x[0] - x[5])
px1 = np.poly1d([1, -x[0]])
px2 = np.poly1d([1, -x[1]])
px3 = np.poly1d([1, -x[3]])
px4 = np.poly1d([1, -x[4]])
...
d = (x[3] - x[0])*(x[3] - x[1])*(x[3] - x[2])*(x[1] - x[4])*(x[0] - x[5])
px1 = np.poly1d([1, x[0]])
px2 = np.poly1d([1, x[1]])
px3 = np.poly1d([1, x[2]])
px4 = np.poly1d([1, x[3]])
