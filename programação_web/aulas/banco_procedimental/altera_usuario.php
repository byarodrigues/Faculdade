								...
								<form method="post" action="salva_alteracao_usuario.php" enctype="multipart/form-data">
									...
									<table>
										...
										<tr> 
											...
											<td>
												<input type="text" size="100" name="txtNome" value="<?php echo $nome; ?>"/>
											</td>
										</tr>
										<tr> 
											<td>
											...
											<td>
												<input type="text" size="30" name="txtLogin" readonly="true" value="<?php echo $login; ?>"/>
											</td>
										</tr>
										<tr> 
											<td>
											...
											<td>
												<input type="password" size="30" name="txtSenha" value="<?php echo $senha; ?>"/>
											</td>
										</tr>
										<tr> 
											<td>
